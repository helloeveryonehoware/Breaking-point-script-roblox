...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       Enabled = true,
       Invite = "Q3pqBxD7G2", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
    ...
    KeySettings = {
       ...
       Subtitle = "Key System",
       Note = "get the key in the discord server https://discord.gg/Q3pqBxD7G2 or https://link-target.net/941382/key",
