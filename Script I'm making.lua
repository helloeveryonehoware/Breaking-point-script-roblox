...
Visuals:NewToggle("ToggleText", "ToggleInfo", function(state)
    if state then
...
L:GetPropertyChangedSignal("Ambient"):connect(function()
    L.Ambient = Color3.fromRGB(254,254,215)
end)
...
L.Ambient = Color3.fromRGB(255,255,255)
L.GlobalShadows = false;
L.MapSaturation = game:GetService("MapSaturation")
L.SkyBox = game:GetService("SkyBox")
L.BlackWhite = game:GetService("BlackWhite")
sethiddenproperty(game.Workspace.Lighting,"Technology",2)
...
Aimbot:NewButton("Activate aimbot", "Loads aimbot into the game", function()
    -- init
...
local ValidTargetParts = {"HumanoidRootPart", "HumanoidRootPart"}
